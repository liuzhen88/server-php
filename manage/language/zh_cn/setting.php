...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:张三,开户行:中国银行天津分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 lisi@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 lisi';
$lang['smtp_user_pwd']           = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip']       = 'lisi@163.com邮件的密码，如 123456';
...
$lang['ftp_attach_dir_tip'] 	= '远程附件目录的绝对路径或相对于 FTP 主目录的相对路径，如果是根目录请填"/"，非根目录，请保证服务器端该目录已存在，结尾不需要"/"，如"/upload/shop"';
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的帐号不要设置可写权限和列表权限。如果是根目录，直接输入域名即可，如“http://www.aigegou.com/”，如果非根目录，需要填写域名+目录形式，如“http://www.aigegou.com/upload/shop”';
