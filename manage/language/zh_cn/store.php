...
$lang['commis_rates_error']       = '请输入正确的佣金';
//二级域名
$lang['if_open_domain']          = '是否启用二级域名';
$lang['open_domain_document']    = '启用二级域名需要您的服务器支持泛域名解析';
$lang['suffix']                  = '二级域名后缀';
$lang['demo']                    = '如店铺的二级域名是"test.aigegou.net", 则要填写"aigegou.com"';
