  ...
  <form id="user_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label for="member_invitation"><?php echo $lang['member_invitation']?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['member_array']['invitation'];?>" id="member_invitation" name="member_invitation" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
