...
<!--        <tr>
          <th class="w150">店铺类型：</th>
          <td><?php /*if(1==$output['joinin_detail']['store_type']) echo '本土';else echo '电商';*/?></td>
        </tr>-->
        <tr>
          <th>店铺等级：</th>
        ...
        <tr>
            ...
            <td><?php if(in_array(intval($output['joinin_detail']['joinin_state']), array(STORE_JOIN_STATE_NEW, STORE_JOIN_STATE_PAY))) { ?>
                    <input type="text"  name="agent_name" value="<?php echo $output['joinin_detail']['agent_name']; ?>">(请输入代理商名称)
                <?php }else{
