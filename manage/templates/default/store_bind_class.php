...
<div class="page">
  ...
  <table class="table tb-type2">
    ...
    <thead>
      <tr class="thead">
        ...
        <th>分类3</th>
        <th>分佣比例</th>
        <?php if ($output['store_info']['store_type']==2) {?>
            <th>分销返佣</th>
        <?php  } ?>
    ...
    <tbody>
      ...
      <tr class="hover edit">
        <td class="w20pre"><?php echo $value['class_1_name'];?></td>
        <td class="w20pre"><?php echo $value['class_2_name'];?></td>
        <td class="w20pre"><?php echo $value['class_3_name'];?></td>
        ...
        <?php if ($output['store_info']['store_type']==2) {?>
            <td class="w25pre"><?php echo $value['distribution_rate'];?>%</td>
        <?php  } ?>
  ...
  <table class="table tb-type2" >
    ...
    <tbody>
      ...
      <tr>
        <td class="required" colspan="2" >分佣比例(必须为100以内的正数)：</td>
      </tr>
      <tr class="noborder">
