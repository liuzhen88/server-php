  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo urlAdmin('goods', 'adt_goods');?>"><span>配送商品申请</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label><?php echo $lang['goods_type']; ?></label></th>
          ...
          <td ><select name="is_distribution" >
                  <option value=""><?php echo $lang['nc_please_choose']; ?>...</option>
                  <option value="2" <?php if ($output['search']['is_distribution'] == '2') { ?>selected<?php } ?>>分销</option>
                  <option value="1" <?php if ($output['search']['is_distribution'] == '1') { ?>selected<?php } ?>>不分销</option>
              </select></td>
          <th><label>分销推荐</label></th>
          <td ><select name="distribution_recommend" >
                  <option value=""><?php echo $lang['nc_please_choose']; ?>...</option>
                  <option value="2" <?php if ($output['search']['distribution_recommend'] == '2') { ?>selected<?php } ?>>推荐</option>
                  <option value="1" <?php if ($output['search']['distribution_recommend'] == '1') { ?>selected<?php } ?>>不推荐</option>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
		  ...
		  <th class="w72 align-center">商品类别</th>
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" nctype="recommand"><span>推荐</span></a> 
                        <a href="JavaScript:void(0);" class="btn" nctype="distribution_recommand"><span>分销推荐</span></a> 
...
$(function(){
    ...
    // 批量推荐处理
    $('a[nctype="recommand"]').click(function(){
       if(confirm('确认要推荐所选的商品吗？')) {
	   $("#form_goods").attr("action", "<?php echo ADMIN_SITE_URL;?>/index.php?act=goods&op=goods&type=recommend");
	    $('#form_goods').submit();
        }
    });
	
    // 批量分销推荐处理
    $('a[nctype="distribution_recommand"]').click(function(){
       if(confirm('确认要分销推荐所选的商品吗？')) {
	   $("#form_goods").attr("action", "<?php echo ADMIN_SITE_URL;?>/index.php?act=goods&op=goods&type=distribution_recommend");
	    $('#form_goods').submit();
        }
    });
