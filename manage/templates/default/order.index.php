    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
         ...
         <th><label><?php echo $lang['pay_sn'];?></label></th>
         ...
         <th><label><?php echo $lang['order_state'];?></label></th>
          <td colspan="4"><select name="order_state" class="querySelect">
              ...
              <option value="35" <?php if($_GET['order_state'] == '35'){?>selected<?php }?>><?php echo $lang['order_state_dispatching'];?></option>
        ...
        <tr>
         ...
         <td>
		  ...
		  <th><label><?php echo $lang['order_type'];?></label></th>
          <td colspan="4"><select name="order_type" >
              <option value=""><?php echo $lang['nc_please_choose'];?></option>
              <option value="3" <?php if($_GET['order_type'] == '3'){?>selected<?php }?>><?php echo $lang['order_dispatching'];?></option>
              <option value="2" <?php if($_GET['order_type'] == '2'){?>selected<?php }?>><?php echo $lang['order_lineon'];?></option>
              <option value="1" <?php if($_GET['order_type'] == '1'){?>selected<?php }?>><?php echo $lang['order_lineoff'];?></option>
            </select></td>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead">
		...
		<th class="align-center"><?php echo $lang['order_type'];?></th>
    ...
    <tbody>
      ...
      <tr class="hover">
		...
		<td class="nowrap align-center"><?php if($order['order_type']==2){?><?php echo $lang['order_lineon'];?><?php }elseif($order['order_type']==3){?><?php echo $lang['order_dispatching'];?><?php }else{ echo $lang['order_lineoff'];}?></td>
