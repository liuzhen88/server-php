    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit row">
          ...
          <td><div class="link-logo"><span class="thumb size-logo"><i></i><img height="31" width="88" src="<?php if(check_remote_file_exists(UPLOAD_SITE_URL.DS.ATTACH_ACTIVITY.DS.$v['activity_banner'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$v['activity_banner'];}else{echo ADMIN_SITE_URL."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,88,31);" /></span></div></td>
