    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td><p><a href="<?php echo SHOP_SITE_URL."/index.php?act=goods&goods_id=".$v['goods_id'];?>" target="_blank"><?php echo $v['goods_name'];?></a></p>
            <p class="store"><?php echo $lang['recommend_goods_store_name'];?>:<a href="<?php echo SHOP_SITE_URL."/index.php?act=show_store&id=".$v['store_id'];?>" target="_blank"><?php echo $v['store_name'];?></a></p></td>
