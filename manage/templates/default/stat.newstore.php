...
<div class="page">
  ...
  <table class="table tb-type2 nobdb">
    ...
    <?php $up_sum=$up_sum+$v['updata'];  $cur_sum=$cur_sum+$v['currentdata'];} ?>
    <?php } else { ?>
    <tr class="no_data">
    ...
    <?php if(!empty($output['statlist']['data']) && is_array($output['statlist']['data'])){ ?>
    <tfoot>
    <tr style="text-align: center;width: 100%"> <td colspan="15" style="text-align: center;width: 100%;height:20px;padding-top: 30px;font-size:16px;"> <div><?php echo $output['statlist']['headertitle'][1]?>总和：<?php echo $up_sum;?>  &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['statlist']['headertitle'][2]?>总和：<?php echo $cur_sum;?></div></td></tr>
      <tr class="tfoot">
