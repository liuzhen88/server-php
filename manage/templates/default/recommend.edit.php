  ...
  <form id="form_add" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><textarea rows="6" class="tarea" id="recommend_http" readonly="readonly" onclick="this.select()"><script type="text/javascript" src="<?php echo SHOP_SITE_URL;?>/api/goods/index.php?id=<?php echo $output['recommend_array']['recommend_id'];?>"></script></textarea></td>
          <td class="vatop tips"></td>
        </tr>
      </tbody>
      <tfoot>
