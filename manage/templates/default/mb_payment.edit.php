  ...
  <form id="post_form" method="post" name="form1" action="<?php echo urlAdmin('mb_payment', 'payment_save');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
            <td colspan="2" class="required"><label class="validation">公众号的key: </label></td>
        </tr>
        <tr class="noborder">
        ...
        <?php } ?>
        <?php if ($output['payment']['payment_code'] == 'wx_app') { ?>
        <tr>
            <td colspan="2" class="required"><label class="validation">公众号的唯一标识（appid）:</label> </td>
        </tr>
        <tr class="noborder">
        ...
        <?php if ($output['payment']['payment_code'] == 'wx_ptb_app') { ?>
            <tr>
                <td colspan="2" class="required"><label class="validation">公众号的唯一标识（appid）:</label> </td>
            </tr>
            <tr class="noborder">
	...
	<?php if ($output['payment']['payment_code'] == 'unionpay') { ?>
            <tr>
                <td colspan="2" class="required"><label class="validation">商户代码码:</label> </td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="unionpay_merId" id="unionpay_merId" value="<?php echo $output['payment']['payment_config']['unionpay_merId'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
            <tr>
                <td colspan="2" class="required"><label class="validation">证书密码:</label></td>
            </tr>
            <tr class="noborder">
                <td class="vatop rowform"><input name="unionpay_certpwd" id="unionpay_certpwd" value="<?php echo $output['payment']['payment_config']['unionpay_certpwd'];?>" class="txt" type="text"></td>
                <td class="vatop tips"></td>
            </tr>
        <?php } ?>
