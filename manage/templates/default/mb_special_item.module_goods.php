...
<script id="item_goods_template" type="text/html">
    ...
    </div><?php //if(isset($output['item_info'])) echo ';special_id:'.$output['item_info']['special_id']; ?>
</script> 
<script src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.ajaxContent.pack.js" type="text/javascript"></script> 
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo urlAdmin('mb_special', 'goods_list',array('special_id'=>intval($output['item_info']['special_id'])));?>';
