...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=store&op=store_joinin_o2o"  class="current"><span>本土开店申请</span></a></li>
  ...
  <form method="get" name="formSearch">
    ...
    <input type="hidden" value="store_joinin_o2o" name="op">
...
<table class="table tb-type2" id="prompt">
    ...
    <div style="text-align:right;"><a class="btns" target="_blank" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&op=export_store_list"><span><?php echo $lang['nc_export'];?>Excel</span></a></div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><?php echo $v['contacts_name'];?></td>
          <td class="w150"><?php echo $v['address'];?></td>
          <td class="align-center"><?php echo $v['contacts_phone'];?></td>
          <td class="align-center"><?php echo date('Y-m-d',$v['apply_time']);?></td>
          ...
          <td class="w72 align-center">
              ...
              <a href="index.php?act=store&op=store_joinin_o2o_detail&id=<?php echo $v['id'];?>">审核</a>
              <?php } else { ?>
              <a href="index.php?act=store&op=store_joinin_o2o_detail&id=<?php echo $v['id'];?>">查看</a>
              <?php } ?>
          </td>
        </tr>
        <?php } ?>
