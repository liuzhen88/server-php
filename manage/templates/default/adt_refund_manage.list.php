...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="act" value="adt_refund" />
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        ...
        <th><select name="type">
            ...
            <option value="pay_sn" <?php if($_GET['type'] == 'pay_sn'){?>selected<?php }?>>支付单号</option>
          </select></th>
  ...
  <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li>买家提交申请，商家同意并经平台确认后，退款金额原路返还给买家。</li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td class="align-center"><?php echo $val['payment_code'];?></td>
        <td class="align-center"><?php echo $val['refund_amount'];?></td>
        <td class="align-center"><?php echo date('Y-m-d H:i:s',$val['add_time']);?></td>
        <td class="align-center"><?php echo $val['success_time']==0?'':date('Y-m-d H:i:s',$val['success_time']); ?></td>
        <td class="align-center"><?php if($val['refund_state']==0){echo '未退款';}elseif($val['refund_state']==1){echo '已退款';} ?></td>
        <td class="align-center"><a href="index.php?act=adt_refund&op=edit&order_id=<?php echo $val['order_id']; ?>"> 确认 </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <?php } else { ?>
