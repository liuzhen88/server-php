    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['goods_class_index_name'];?></th>
		      <th><?php echo $lang['goods_class_type'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <a class="btn-add-nofloat marginleft" href="index.php?act=goods_class&op=goods_class_add&gc_parent_id=<?php echo $v['gc_id'];?>&class_type=<?php echo $v['class_type'];?>"><span><?php echo $lang['nc_add_sub_class'];?></span></a>
          </td>
		  <td><?php if ($v['class_type'] == 0) {?>商城<?php }elseif($v['class_type'] == 1){ ?>本土<?php }elseif($v['class_type'] == 3){ ?>配送<?php }?></td>
          <td><?php echo $v['type_name'];?></td>
          <td><?php echo $v['commis_rate'];?> %</td>
          <td><?php echo $v['distribution_rate'];?> %</td>
