  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item"> <img nctype="image" src="<?php echo getMbSpecialImageUrl($item_value['image']);?>" alt="">
      ...
      <input nctype="image_data" name="item_data[item][<?php echo $item_key;?>][data]" type="hidden" value="<?php echo $item_value['data'];?>">
        <?php if(isset($item_value['title'])){ ?>
      <input nctype="image_title" name="item_data[item][<?php echo $item_key;?>][title]" type="hidden" value="<?php echo $item_value['title'];?>">
        <?php } ?>
        <?php if(isset($item_value['describe'])){ ?>
      <input nctype="image_describe" name="item_data[item][<?php echo $item_key;?>][describe]" type="hidden" value="<?php echo $item_value['describe'];?>">
        <?php } ?>
