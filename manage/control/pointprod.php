		...
		if (chksubmit()){
			...
			if($state){
				...
				if ($indeximg_succ){
					...
					$insert_array['file_size'] = filesize(UPLOAD_SITE_URL.DS.ATTACH_POINTPROD.DS.$upload->file_name);
...
//							@unlink(BASE_UPLOAD_PATH.DS.ATTACH_POINTPROD.DS.$v['file_thumb']);
                            ...
                            $QNupload->delFileQny(ATTACH_POINTPROD.DS.$v['file_name']);
                            $QNupload->delFileQny(ATTACH_POINTPROD.DS.$v['file_thumb']);
...
//			@unlink(BASE_UPLOAD_PATH.DS.ATTACH_POINTPROD.DS.$file_array['file_name']);
            $QNupload=new uploadFile();
            $QNupload->delFileQny(ATTACH_POINTPROD.DS.$file_array['file_name']);
			/**
			 * 删除信息
			 */
