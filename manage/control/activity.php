...
//			@unlink(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$upload->file_name);
            $upload->delFileQny(ATTACH_ACTIVITY.DS.$upload->file_name);
...
//				@unlink(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$row['activity_banner']);
                $upload->delFileQny(ATTACH_ACTIVITY.DS.$row['activity_banner']);
			}
...
//		@unlink(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$row['activity_banner']);
        ...
        $QNupload->delFileQny(ATTACH_ACTIVITY.DS.$row['activity_banner']);
