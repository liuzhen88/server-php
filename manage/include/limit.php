...
$_limit =  array(
	...
	array('name'=>$lang['nc_store'], 'child'=>array(
		...
		array('name'=>'自营店铺', 'op'=>null, 'act'=>'ownshop'),
                array('name'=>'代理商管理',  'op'=>null, 'act'=>'agent'),
		)),
	array('name'=>$lang['nc_member'], 'child'=>array(
		...
		array('name'=>$lang['nc_member_rebatemanage'], 'op'=>null, 'act'=>'rebate'),
	...
	array('name'=>$lang['nc_trade'], 'child'=>array(
		...
		array('name'=>'预充值管理', 'op'=>null, 'act'=>'pre_deposit'),   //权限控制
		)),
	...
	array('name'=>$lang['nc_operation'], 'child'=>array(
	    ...
	    array('name'=>'代理商/商户公告','op'=>null, 'act'=>'agent_notice'),
	    array('name'=>'发现管理','op'=>null, 'act'=>'circle_manage'),
		array('name'=>'广告管理','op'=>null, 'act'=>'fix_adv'),
		array('name'=>'短信群发','op'=>null, 'act'=>'sms_send'),
		)),
	array('name'=>$lang['nc_stat'], 'child'=>array(
		...
		array('name'=>$lang['nc_orderanalysis'], 	'op'=>'order_analysis', 'act'=>'order'),
		)),
);
