		...
		'left' =>array(
			...
			3 => array(
				...
				'list' => array(
					...
					array('args'=>'list,ownshop,store',				'text'=>'自营店铺'),
                                        array('args'=>'agent,agent,store',			        'text'=>'代理商管理'),
				)
			),
			4 => array(
				'nav' => 'member',
				...
				'list' => array(
					...
					array('args'=>'index,rebate,member',				'text'=>'返利统计'),
			...
			5 => array(
				...
				'list' => array(
					...
					array('args'=>'leagueNewList,complain,trade',		'text'=>'跑腿邦投诉反馈'),
					array('args'=>'log,pre_deposit,trade',		'text'=>'预充值管理'),      //args:入口方法，控制器，所属栏目名称('nav' => 'trade')
					array('args'=>'adt_assist_index,order,trade',		    'text'=>'待协调处理订单'),
					array('args'=>'refund_manage,adt_refund,trade',		'text'=>'跑腿邦退款管理'),
				)
			),
			6 => array(
				'nav' => 'website',
				...
				'list' => array(
					...
					array('args'=>'web_config1,web_config,website',			'text'=>$lang['nc_web_market']),
					array('args'=>'rec_list,rec_position,website',			'text'=>$lang['nc_admin_res_position']),
					array('args'=>'recommend,recommend,website',			'text'=>'商品推荐'),
			...
			7 => array(
				...
				'text' => $lang['nc_operation'],
				'list' => array(
                                        array('args'=>'index,fix_adv,operation',             	'text'=>$lang['nc_adv']),
                    ...
                    array('args'=>'index,agent_notice,operation',               'text'=>'代理商/商户公告'),
                    array('args'=>'index,circle_manage,operation',              'text'=>'发现管理'),
					array('args'=>'index,sms_send,operation',                   'text'=>'短信群发'),
				)
			),
			8 => array(
				'nav' => 'stat',
				...
				'list' => array(
					...
					array('args'=>'order_analysis,order,stat',			'text'=>$lang['nc_orderanalysis']),
				)
			),
		),
);
