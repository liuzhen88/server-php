            ...
            foreach($picture_list as $picture) {
                ...
                if(!empty($picture_image_list)) {
                    foreach ($picture_image_list as $value) {
                        ...
                        $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$picture['picture_attachment_path'].DS.$value['image_name']);
                        $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$picture['picture_attachment_path'].DS.$base_name.'_list.'.$ext);
                        $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$picture['picture_attachment_path'].DS.$base_name.'_max.'.$ext);
