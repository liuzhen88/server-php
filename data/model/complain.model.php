...
class complainModel extends model{
     ...
     * @return int
     */
    public function adt_getComplainCount($condition) {
        return $this->table('complain_league')->where($condition)->count();
    }
    ...
    /**
     * tousu
     * functionname   : adt_saveComplain
     * author         : xuping
     * @param $param
     * @return false|int|mixed
     */
    public function adt_saveComplain($param){
        return Db::insert('complain_league',$param) ;
    }
