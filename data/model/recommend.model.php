...
class recommendModel{
	...
	public function getRecommendGoodsList($condition,$page=''){
		...
		$param = array(
			'table'=>'recommend,recommend_goods,goods,goods_common,store,brand',
			'field'=>'recommend.recommend_name,recommend.recommend_code,recommend_goods.*,goods.*,store.store_name,goods_common.gc_name,brand.brand_name',
			'where'=>$condition_str,
			...
			'join_on'=>array(
                ...
                'goods.goods_commonid=goods_common.goods_commonid',
	...
	public function getGoodsList($condition,$page=''){
		...
		$param['field'] = $condition['field'] ? $condition['field'] : 'recommend_goods.sort,goods.goods_commonid,goods.store_id,goods.goods_name,goods.goods_image,goods.goods_price,goods.goods_id';
		$param['where']	= $condition_str;
		$param['join_type']	= 'left join';
		$param['join_on']	= array('recommend_goods.goods_id=goods.goods_id');
		$param['order'] = $condition['order'] ? $condition['order'] : 'recommend_goods.sort asc,goods.goods_commonid desc';
