                ...
                if(!empty($article['article_image_all'])) {
                    ...
                    if(!empty($article_image_array) && is_array($article_image_array)) {
                        foreach ($article_image_array as $key=>$value) {
                            ...
                            $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$attachment_path.DS.$key);
                            $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$attachment_path.DS.$base_name.'_list.'.$ext);
                            $QNupload->delFileQny(ATTACH_CMS.DS.'article'.DS.$attachment_path.DS.$base_name.'_max.'.$ext);
