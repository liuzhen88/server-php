...
class buyModel {
    ...
    public function pdPay($order_list, $input, $member_id, $member_name) {
        ...
        $buyer_info	= Model('member')->getMemberInfo(array('member_id' => $member_id),'available_predeposit,member_paypwd,member_salt');
        if ($buyer_info['member_paypwd'] == '' || $buyer_info['member_paypwd'] != md6($input['password'], $buyer_info['member_salt'])) return ;
