...
class store_joininModel extends Model{
     ...
     * daliang
     */
    public function getStoreJoininO2o($condition,$field='*'){
        $result = $this->table('store_o2o_joinin')->field($field)->where($condition)->find();
        return $result;
    }
    /**
     * 获取本土商户入驻详情
     ...
     * daliang
     */
    public function updateStoreJoininO2o($condition,$update){
        $result = $this->table('store_o2o_joinin')->where($condition)->update($update);
        return $result;
    }
	/**
	 * 店铺入住数量
