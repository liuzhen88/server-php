...
class tradeModel extends Model{
	...
	public function getMaxDay($day_type = 'all') {
		$max_data = array(
                    'order_cancel' => ORDER_AUTO_CANCEL_DAY,//未选择支付方式时取消订单
                    'order_confirm' => ORDER_CONFIRM_DAY,//买家不收货也没退款时自动完成订单
                    'order_refund' => ORDER_REFUND_DAY,//收货完成后可以申请退款退货
                    'refund_confirm' => ORDER_REFUND_CONFIRM_DAY,//卖家不处理退款退货申请时按同意处理
                    'return_confirm' => ORDER_RETURN_CONFIRM_DAY,//卖家不处理收货时按弃货处理
                    'return_delay' => ORDER_RETURN_DELAY_DAY//退货的商品发货多少天以后才可以选择没收到
		 );
