...
for(var i=0; i<ProvinceCount; i++){
 ...
 function twolev(){
   ...
   $.ajax({
          type:"post",     
          url:"index.php?s=/home/index/val",
          data:{id:id},
          dataType:'json',
          success:function(data){
            $('#nums').text(data.value);
          },
   });

   $.ajax({
          type:"post",     
          url:"index.php?s=/home/index/two",
          data:{id:id},
          dataType:'json',
          success:function(data){
          ...
          // $('#nums').text(value);
           ...
           rate.after('<select name="two" id="two" value="" onchange="numss();"></select>');
           var select=$('#two');
           select.append('<option value="">请选择</option>');
           
            $.each(data,function(i,sele){
            select.append('<Option value='+sele.id+'>'+sele.name+'</Option>');
            });
          
           // $('#te').html(decodeURI(result));     
          },
          error:function(){
...
function numss(){
 var num=$('#two').val();
   ...
   $.ajax({
          type:"post",     
          url:"index.php?s=/home/index/num",
          data:{id:num},
          dataType:'json',
          success:function(data){
         //  alert(data.name);
