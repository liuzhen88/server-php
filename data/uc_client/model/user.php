...
class usermodel {
	...
	function add_user($username, $password, $email, $uid = 0, $questionid = '', $answer = '', $regip = '') {
		...
		//$this->db->query("INSERT INTO ".DX_DBTABLEPRE."member SET  uid='$uid',email='$email', username='$username', password='$dxpassword',groupid='10',regdate='".$this->base->time."',timeoffset='9999'");
		//$this->db->query("INSERT INTO ".DX_DBTABLEPRE."member_count SET  uid='$uid',extcredits2='15'");
