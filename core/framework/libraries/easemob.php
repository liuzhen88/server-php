...
//------------------------------------------------------用户体系	
	...
	public function __construct($options) {
		$this->client_id = isset ( $options ['client_id'] ) ? $options ['client_id'] : C('easemob.client_id');
		$this->client_secret = isset ( $options ['client_secret'] ) ? $options ['client_secret'] : C('easemob.client_secret');
		$this->org_name = isset ( $options ['org_name'] ) ? $options ['org_name'] : C('easemob.org_name');
		$this->app_name = isset ( $options ['app_name'] ) ? $options ['app_name'] : C('easemob.app_name');
		if (! empty ( $this->org_name ) && ! empty ( $this->app_name )) {
			$this->url = C('easemob.base_url') . $this->org_name . '/' . $this->app_name . '/';
		}
	}	
	/**
	*获取token 
	...
	*/
	 ...
	 */
	public function registerToken($username,$password,$nickname='')
	{
	...
	*/
	 ...
	 * @return [type]              [description]
	 */
	function changePwdToken($username,$newpassword,$password)
	{
